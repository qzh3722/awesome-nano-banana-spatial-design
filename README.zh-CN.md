...
**本阶段案例：**  
[1.1 自动布置平面图](#11-自动布置平面图-auto-furnish-floor-plan) • [1.2 平地起高楼](#12-平地起高楼-building-from-scratch) • [1.3 迷你建筑模型](#13-迷你建筑模型-miniature-building-model) • [1.4 生成式设计推演](#14-生成式设计推演)
