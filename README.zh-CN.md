...
**本阶段案例：**  
[1.1 衣橱拆解与风格分析](#11-衣橱拆解与风格分析) • [1.2 3D 店铺渲染图](#12-3d-店铺渲染图)
...
**本阶段案例：**  
[2.1 CAD平面图转彩色平面图](#21-cad平面图转彩色平面图) • [2.2 景观分区分析图](#22-景观分区分析图) • [2.3 城市肌理底图风格化](#23-城市肌理底图风格化) • [2.4 办公位布局优化](#24-办公位布局优化)
...
**提示词：**
```
场地分析图。在总平面图上叠加颜色编码区域：绿色代表'公共公园'，蓝色代表'水景 '，黄色代表'居住区'。使用填充图案和图例。矢量图形风格。
```
...
**提示词：**
```
开放式办公室室内。成排的现代白色办公桌搭配符合人体工程学的黑色椅子。用种有 虎尾兰的种植箱分隔各排。繁忙的专业氛围，白天。
```
