...
![Site Plan Input](../../assets/cases/2.3-site-plan-to-aerial/input.jpg)
*Input: Site Plan CAD / 输入：总平面CAD*

![Aerial View Output](../../assets/cases/2.3-site-plan-to-aerial/output.jpg)
...
![Aerial View Output (Morning)](../../assets/cases/2.3-site-plan-to-aerial/output.jpg)
*Input: Previous Output (Morning) / 输入：上一步输出（清晨）*

![Nighttime Output](../../assets/cases/2.3-site-plan-to-aerial/output-night.jpg)
