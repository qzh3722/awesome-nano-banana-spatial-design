...
![Input CAD](../../assets/cases/2.1-cad-to-topview/input.jpg)
*Input: CAD Floor Plan / 输入: CAD 平面图*

![Output Layout](../../assets/cases/2.1-cad-to-topview/output-json.jpg)
*Output: Photorealistic Furniture Layout / 输出: 照片级家具布局*
