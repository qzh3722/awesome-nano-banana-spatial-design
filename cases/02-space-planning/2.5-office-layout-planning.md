...
>
> Design a complete office layout with ergonomic workstations and functional zones based on an empty floor plan.
>
> **办公空间规划。**
>
> 基于空置平面图，设计包含符合人体工程学的工作站和功能区域的完整办公室布局。
...
*Output: Proposed Office Layout / 输出：建议办公室布局*
...
## 🏷️ Tags
`#space-planning` `#office-design` `#layout-optimization` `#ergonomics`
`#空间规划` `#办公设计` `#布局优化` `#人体工程学`
