...
### Outputs
#### Method 1: Universal Template Result / 通用模板生成结果
![Method 1 Output](../../assets/cases/3.3-elevation-to-render/output.jpeg)
*Generated via Universal Template / 由通用模板生成*

#### Method 2: Meta-Prompt Result / 元提示词生成结果
![Method 2 Output](../../assets/cases/3.3-elevation-to-render/output-meta.jpeg)
*Generated via Meta-Prompt (Auto-Analysis) / 由元提示词（自动分析）生成*
