...
>
> Illustrate the conceptual evolution of the building form from a simple geometric mass to the final design in a 4-stage sequence.
>
> **生成式设计推演图。**
>
> 以四阶段序列展示建筑形式从简单几何体块到最终设计的概念演变过程。

![Input Image](../../assets/cases/1.4-generative-design-process/input.jpg)
*Input: Final Building Image / 输入：最终建筑图像*

![Output Image](../../assets/cases/1.4-generative-design-process/output.jpg)
*Output: Generative Process Diagram / 输出：生成过程图解*
...
## 🏷️ Tags
`#concept-ideation` `#generative-design` `#process-diagram` `#form-evolution`
`#概念构思` `#生成式设计` `#过程图解` `#形式演变`
