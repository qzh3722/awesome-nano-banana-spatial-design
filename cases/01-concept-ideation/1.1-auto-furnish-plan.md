...
> Automatically arrange furniture in a blank floor plan based on room labels.
>
> 根据房间标签自动在空白平面图中布置家具。

![Auto-Furnish Input](../../assets/cases/1.1-auto-furnish-plan/input.jpg)
*Input: Blank Floor Plan / 输入：空白平面图*

![Auto-Furnish Output](../../assets/cases/1.1-auto-furnish-plan/output.jpg)
*Output: Furnished Floor Plan / 输出：布置后的平面图*
...
`#concept-ideation` `#auto-furnish` `#floor-plan` `#layout-generation`
`#概念构思` `#自动布置` `#平面图` `#布局生成`
