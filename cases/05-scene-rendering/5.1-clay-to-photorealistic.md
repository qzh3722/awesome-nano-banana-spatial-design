...
## Method A: Text-Specified Style / 方案A：文字指定风格

*Use text descriptions to define the target style and materials. / 使用文字描述来定义目标风格和材质。*

**Output:**

![Output Cream](../../assets/cases/5.1-clay-to-render/output-cream.jpg)
*Cream Luxury Style / 奶油色轻奢风*

---

## Method B: Image Reference Style / 方案B：图片参考风格

*Use an existing interior photo as style reference. Upload order: 1st = Style Reference, 2nd = Clay Model. / 使用现有室内照片作为风格参考。上传顺序：第一张=风格参考图，第二张=白模图。*

**Input 1 - Style Reference / 输入1 - 风格参考图:**

![Style Reference](../../assets/cases/5.1-clay-to-render/ref-dark-style.jpg)
*Style/Material Reference Image / 风格/材质参考图片*

**Input 2 - Clay Model / 输入2 - 白模图:**

![Input Image](../../assets/cases/5.1-clay-to-render/input.jpg)
*Clay/White Model Render (same as above) / 白模渲染图（同上）*

**Output:**

![Output Dark](../../assets/cases/5.1-clay-to-render/output-dark.png)
*Dark Wood Japanese Style (Generated from Reference) / 深色木质日式风（基于参考图生成）*
